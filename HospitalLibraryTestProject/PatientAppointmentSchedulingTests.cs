...
namespace HospitalLibraryTestProject
{
    public class PatientAppointmentSchedulingTests
    {
        ...
        private void Setting_appointment_repository()
        {
            ...
            appointments.Add(new Appointment { Id = "APP1", DoctorId = "1", Start = new DateTime(2022, 12, 15, 12, 0, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP2", DoctorId = "1", Start = new DateTime(2022, 12, 16, 12, 20, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP3", DoctorId = "1", Start = new DateTime(2022, 12, 17, 12, 40, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP4", DoctorId = "2", Start = new DateTime(2022, 12, 18, 12, 0, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP5", DoctorId = "2", Start = new DateTime(2022, 12, 19, 12, 20, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP6", DoctorId = "2", Start = new DateTime(2022, 12, 19, 12, 40, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP7", DoctorId = "2", Start = new DateTime(2022, 12, 19, 13, 20, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP8", DoctorId = "2", Start = new DateTime(2022, 12, 19, 13, 40, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP9", DoctorId = "2", Start = new DateTime(2022, 12, 19, 14, 00, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP10", DoctorId = "2", Start = new DateTime(2022, 12, 19, 14, 20, 0), PatientId = "PACIJENT" });
            appointments.Add(new Appointment { Id = "APP11", DoctorId = "2", Start = new DateTime(2022, 12, 19, 14, 40, 0), PatientId = "PACIJENT" });
