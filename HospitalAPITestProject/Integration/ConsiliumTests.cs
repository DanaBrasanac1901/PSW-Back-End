...
namespace HospitalAPITestProject.Integration
{
    public class ConsiliumTests : BaseIntegrationTest
    {
        ...
        private static CreateConsiliumDTO SetUpCreateConsiliumDTO(IServiceScope scope)
        {
            return new CreateConsiliumDTO(scope.ServiceProvider.GetRequiredService<IConsiliumService>());
        }
        ...
        public void Create_consilium()
        {
            ...
            var result = ((CreatedAtActionResult)controller.CreateConsilium(consilium))?.Value as Consilium;
